...
<v-sheet elevation="17" id="recDiv" class="divstyle">
    ...
    <v-container :class="bgcolor" v-if="rapporto >= 3 / 2 && rapporto < 5/2" class="containerstyle" style="border-bottom-left-radius: 3px;border-bottom-right-radius: 3px;" fluid>
        <v-row align="center">
    ...
    <v-container :class="bgcolor" v-if="rapporto >= 5/2" class="containerstyle" style="border-bottom-left-radius: 3px;border-bottom-right-radius: 3px;" fluid>
        <v-row align="center">
