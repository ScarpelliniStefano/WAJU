<template>
    <v-sheet elevation="17" id="recDiv" class="divstyle">
        ...
        <v-container v-if="rapporto < 3/2" class="containerstyle" fluid>
            <v-row align="center">
                <v-col
                    id="col-ta-send"
                    :key="1.1"
                ...
                <v-col :key="1.2" cols="12" :sm="12" :md="12" :lg="12" :xl="12">
                    <v-row align="center" class="text-center">
                        <v-col>
                            <v-btn class="tooltip btnstyle" style="background-color: var(--border-color);" tile fab depressed elevation="5" raised @click="sendMessage()">
                                <v-icon color="white" large>mdi-play</v-icon>
                                <span class="tooltiptext">Execute command</span>
                            </v-btn>
                        </v-col>
                        <v-col>
                            <v-btn class="tooltip btnstyle" style="background-color: var(--border-color);" tile fab depressed elevation="5" raised @click="overlay = !overlay;">
                ...
                <v-col :key="1.2" cols="2" :sm="2" :md="2" :lg="2" :xl="2">
                    <v-row align="center" class="text-center">
                        <v-col cols="12" :sm="12" :md="12" :lg="12" :xl="12">
                            <v-btn large class="tooltip btnstyle" tile style="background-color: var(--border-color);" fab depressed elevation="2" raised @click="sendMessage()">
                                <v-icon color="white" large>mdi-play</v-icon>
                                <span class="tooltiptext">Execute command</span>
                            </v-btn>
                        </v-col>
                        <v-col cols="12" :sm="12" :md="12" :lg="12" :xl="12">
                            <v-btn large class="tooltip btnstyle" tile style="background-color: var(--border-color);" fab depressed elevation="2" raised @click="overlay = !overlay;">
                                <v-icon color="white" large>mdi-auto-fix</v-icon>
                                <span class="tooltiptext">Wizard</span>
                            </v-btn>
                            <v-overlay absolute opacity="0.9" :value="overlay" color="white">
                ...
                <v-col
                    ...
                    <v-col :key="1.2" :cols="2">
                        <v-row align="center">
                            <v-col>
                                <v-sheet :height="(height-80)/2">
                                    <v-btn :width="width/6 - 36" x-large class="tooltip btnstyle" tile style="align-items: center; justify-content: center; color: white; background-color: var(--border-color); position: relative; top:50%; transform: translate(0, -40%); border-radius: 4px; border-style: solid; border-width: 1px; " fab depressed elevation="5" raised @click="sendMessage()">
                        ...
                        <v-row align="center">
                            <v-col>
                                <v-sheet :height="(height-80)/2">
                                    <v-btn :width="width/6 - 36" x-large class="tooltip btnstyle" tile style="color: white; background-color: var(--border-color); position: relative; top:50%; transform: translate(0, -60%); border-radius: 4px; border-style: solid; border-width: 1px; " fab depressed elevation="5" raised @click="overlay = !overlay;">
